...
let TabGamePageModule = class TabGamePageModule {
};
...
let TabGamePage = class TabGamePage {
    // Appelé qu'une seule fois
    constructor(api, categories, game, database, alertCtrl, toastCtrl, modalCtlr, loadingCtrl) {
        this.api = api;
                ...
                buttons: [
                    {
                        ...
                        handler: () => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                            const a = yield this.loadingCtrl.create({
                                message: '<div class="loading-category text-center">' +
                                    '<div><img class="rotating" src="../../assets/img/categories/' + category.icon + '.png"/></div>' +
                                    '<div class="bon-courage">Bon courage ...</div>' +
                                    '</div>',
...
//# sourceMappingURL=tab-game-tab-game-module-es2015.js.map